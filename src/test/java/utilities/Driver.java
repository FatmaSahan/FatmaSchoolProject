...
public class Driver {
    ...
    public static void clearWithJS(WebElement element) {
        ((JavascriptExecutor) Driver.getDriver()).executeScript("arguments[0].value = '';", element);
        }

    public static void setWithJS(WebElement element,String data) {
        ((JavascriptExecutor) Driver.getDriver()).executeScript("arguments[0].scrollIntoView(true);", element);
        ((JavascriptExecutor) Driver.getDriver()).executeScript("arguments[0].value = '"+data+"';", element);
    }

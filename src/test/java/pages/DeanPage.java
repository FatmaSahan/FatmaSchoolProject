...
//kamil
    ...
    @FindBy(xpath="(//button[contains(text(),'Edit')])[13]")
    ...
    public List<WebElement> deanUserNameList;

    @FindBy(xpath="//*[text()='›']")
    public WebElement forwardButton;

    @FindBy(xpath="//*[contains(text(),'Page')]")
    public WebElement pagesSum;
    ...
    @FindBy(xpath="(//input[@class='form-check-input'])[4]")
    public WebElement genderChckBox;

    @FindBy(xpath ="(//input[@placeholder='Phone Number'])[2]")
    public WebElement phoneNumberInput;

    @FindBy(xpath ="(//input[@placeholder='ssn'])[2]")
